...
class AddPetForm(FlaskForm):
    ...
    species = StringField("Species", validators=[InputRequired("Species cannot be blank")])
    age = FloatField("Pet Age", validators=[Optional(), NumberRange(min=0, max=30, message="Age must be a number 0 - 30 ")])
